...
server_locket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
server_locket.bind(('localhost', 12345))
server_locket.listen(5)
...
while True:
    client_socket, client_address = server_locket.accept()
