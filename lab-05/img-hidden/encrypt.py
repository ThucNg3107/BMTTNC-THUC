...
def encode_image(image_path, message):
    ...
    binary_message += '111111111110'  # Dấu hiệu kết thúc

    # Kiểm tra ảnh có đủ chỗ chứa không
    if len(binary_message) > width * height * 3:
        print("Error: Image is too small to hold the message.")
        return
    data_index = 0
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python ecrypt.py <image_path> <message>")
        return
